...
part of 'resource_inspector_contract.dart';

const String resourceInspectorServiceId = 'resourceInspector';
...
final class ResourceInspectorServiceDispatcher
  ...
  Future<Map<String, Object?>> dispatch(
    ...
    if (!const {resourceInspectorServiceInspectId}.contains(_adeleMethod2))
      return _contractFailure(
        _adeleRequestId1,
        null,
        'unknown_method',
    ...
    try {
      _adeleArguments6 = switch (_adeleMethod2) {
        resourceInspectorServiceInspectId => (() {
          ...
          return <Object?>[_decodeResourceRef(_adelePayload4['resource'])];
        })(),
    ...
    try {
      _adeleResult8 = await switch (_adeleMethod2) {
        resourceInspectorServiceInspectId => (() async {
          final _adeleValues0 = _adeleArguments6 as List<Object?>;
          return await this._adeleService.inspect(
            _adeleValues0[0] as ResourceRef,
          );
        })(),
        _ => throw const _ContractUnknownMethod(),
      };
    } on ResourceInspectorFailure catch (_adeleError9) {
      try {
        return _contractFailure(
          _adeleRequestId1,
          resourceInspectorFailureTypeId,
          _adeleError9.code,
    ...
    try {
      final _adeleEncoded11 = switch (_adeleMethod2) {
        resourceInspectorServiceInspectId => _encodeResourceInspection(
          (_adeleResult8 as ResourceInspection),
        ),
        _ => throw const _ContractUnknownMethod(),
      };
      return {
...
const String resourceInspectorFailureTypeId = 'resourceInspector.failure';
const String resourceInspectionTypeId = 'resourceInspector.inspection';
Map<String, Object?> _encodeResourceInspection(
  ResourceInspection _adeleValue9,
) => <String, Object?>{
  'providerLabel': _adeleValue9.providerLabel,
  'resource': _contractResourceRef(_adeleValue9.resource),
  'summary': _adeleValue9.summary,
};
ResourceInspection _decodeResourceInspection(Object? _adeleValue16) {
  final _adeleMap17 = _contractMap(_adeleValue16, 'ResourceInspection');
  _contractFields(_adeleMap17, const {
    'providerLabel',
    'resource',
    'summary',
  }, 'ResourceInspection');
  final _adeleField18 = _contractString(
    _adeleMap17['providerLabel'],
    'providerLabel',
  );
  final _adeleField19 = _decodeResourceRef(_adeleMap17['resource']);
  final _adeleField20 = _contractString(_adeleMap17['summary'], 'summary');
  return _contractConstruct(
    'ResourceInspection',
    () => ResourceInspection(
      providerLabel: _adeleField18,
      resource: _adeleField19,
      summary: _adeleField20,
    ),
  );
}
