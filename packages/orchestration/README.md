...
Both host/plugin protocols are version 3. Source capture remains unary and
read-only; reverse server streaming serves separately authorized process tools,
