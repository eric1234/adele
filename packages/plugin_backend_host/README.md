...
`plugin_backend_host` is an internal pure-Dart executable package for the Phase
1 shared process-host experiment. One AOT host process accepts framed stdin,
