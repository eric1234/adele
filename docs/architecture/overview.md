...
- additional Environment providers, process modes beyond the V-C1 foreground surface, real-model command use, and broader model-facing mutable source tooling such as creation/deletion/general writes;
