...
| Experimental ChatGPT configured instance | Auth/routing tests provide interoperability evidence; the migrated source-coding smoke remains opt-in and was not rerun for V-A5 without the explicit live-test environment. |
