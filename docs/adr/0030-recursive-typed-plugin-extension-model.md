...
- ready backend extension advertisements become exact-generation host proxies in the existing registry, with coherent capability/extension rollback and retirement. [ADR 0032](0032-remote-backend-extensions-use-operation-scoped-host-services.md) records the operation-scoped host-service decision and its implemented subset;
