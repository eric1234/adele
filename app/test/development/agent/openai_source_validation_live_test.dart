...
const String _validationPrompt =
    'Read plugins/chat_strategy/packages/backend/lib/chat_strategy_backend.dart. '
...
_ValidationEvidence _expectSuccessfulValidationRun({
  ...
  final List<SourceCodingToolAttempt> commands = sourceCodingToolAttempts(
    records,
    'run_command',
  );
  ...
  final SourceCodingToolAttempt command = commands.single;
